...
<body>
    ...
    <main class="main">
        <section class="section">
            <div class="inputs">
                <div class="div">
                    <h2 class="hh">Le Locataire</h2>
                    <form action="tr.php" method="post">
                        <input class="p1" type="email" name="email" id="email" placeholder="Email Address" required><br><br>
                        <input class="p1" type="password" name="password" id="password" placeholder="Mot de passe" required><br><br>
                        <a href="oublie_tenant.php" class="oublie">Mot de passe oublié?</a><br><br>
    ...
    <div class="continue">
        <div class="article">
            <p class="or">_______ Ou Continuer avec _______</p>
        </div>
        <div class="images">
            <a href="#" class="a1"><img src="images/f.png" alt="facebook" width="25px" height="25px" class="img2"></a>
            <a href="#" class="a1"><img src="images/g.png" alt="google" class="img2" width="25px" height="25px"></a>
        </div>
        <a href="register_tenant.php" class="a2">Créer un compte</a>
    </div>
</div>
</main>
</div>
