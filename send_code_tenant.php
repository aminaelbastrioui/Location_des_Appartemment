            ...
            <div class="inputs">
                <div class="div">
                    ...
                    <form action="tr.php" method="post">
                        <input class="p1" type="text" name="code" id="code" placeholder="Verification Code" required><br><br>
                        <input class="p1" type="password" name="newpassword1" id="new_pass1" placeholder="Nouveau mot de passe" required><br><br>
                        <input class="p1" type="password" name="newpassword2" id="new_pass2" placeholder="Confirmez le mot de passe" required><br><br>
                        <input class="p2" type="submit" value="Confirme" name="Connexion6">
                    </form>   
                </div>
            </div>
        </section>
